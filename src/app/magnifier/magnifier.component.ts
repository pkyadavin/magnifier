...
export class MagnifierComponent implements OnChanges, OnInit, AfterViewInit {
    ...
    totalImagens: number=0;
    indexImagemAtual: number=0;
    rotacaoImagemAtual: number=0;
    stringDownloadImagem: string="";
    isImagemVertical: boolean=false;
    showOnlyPDF = false;
    ...
    inicializarImageViewer() {
        console.log("inicializarImageViewer");
        ...
        this.wrapper = document.getElementById("idOnHTML");
    ...
    carregarViewerPDF() {
        ...
        this.injetarIframe(widthIframe||0, heightIframe||0);
    }
    ...
    getScale() {
        ...
        const containerElement = document.getElementById(this.idContainer)||new HTMLElement();
        const ivLargeImageElement = document.getElementById(this.idContainer)?.getElementsByClassName('iv-large-image').item(0)||new HTMLElement() ;
    ...
    private getImagemAtual() {
        console.log("getImagemAtual");
        console.log(this.images[this.indexImagemAtual - 1]);
    ...
    setStyleClass(nomeClasse: string, nomeStyle: string, cor: string) {
        ...
        let cont;
        const listaElementos = document.getElementById(this.idContainer)?.getElementsByClassName(nomeClasse)||new HTMLCollection();
